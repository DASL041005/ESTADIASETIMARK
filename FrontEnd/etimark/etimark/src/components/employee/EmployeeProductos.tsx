...
const EmployeeProductos: React.FC = () => {
  ...
  if (loading) return <h2 className="pedidos-title">Cargando productos...</h2>;
  if (error) return <h2 className="pedidos-title error">{error}</h2>;
